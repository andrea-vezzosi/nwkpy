...
# conevergence threshold for charge in dk
maxchargeerror_dk = 1e-3


################# BROYDEN MIXING ###################
# simple mixing parameter
betamix = 0.35
# max number of previous iterations
maxter = 6
# weight fro m=0
w0 = 0.01
# whether to use m-dependent weights for m>0
use_wm=True
# reset history at the following iteration number(s)
toreset = []
...
plotting_preferencies_bands = {
    'xlim' : (0,0.06), # nm^-1
    'ylim' : (528,545), # meV
    'chemical_potential' : 539.1444444, #meV
    'cmap_in' : 'rainbow',
